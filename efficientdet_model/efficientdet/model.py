...
class Regressor(nn.Module):
    ...
    def forward(self, inputs):
        ...
        for feat, bn_list in zip(inputs, self.bn_list):
            ...
            total_number_temp = feat.shape[1] - (1 if total_number == 0 else 0)
            self.pyramid_limits.append((total_number + (0 if total_number == 0 else 1), 
                                        total_number + total_number_temp))
            total_number += total_number_temp
            
            #Example output:
                #[(0, 36863),        --> level P3
                # (36864, 46079),    --> level P4 
                # (46080, 48383),    --> level P5 
                # (48384, 48959),    --> level P6  
                # (48960, 49103)]    --> level P7 
            #------------------------------------------------------------------
